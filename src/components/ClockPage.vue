<template>
    <div class="clock-container">
        ...
        <div class="row-3">
            <div class="row-item">
                <p v-if="weather.main" class="current-temp font-l">
        ...
        <div class="row-4">
            <div v-if="forecast.daily" class="forecast-container">
                <div
                    v-for="day in forecast.daily.slice(0, 4)"
                    :key="`forecast_day_${day.dt}`"
                    class="forecast-day"
                >
...
export default {
    ...
    methods: {
        ...
        updateTime() {
            ...
            const t = {
                w: weekdays[cd.getDay()],
                M: months[cd.getMonth()],
                d: cd.getDate(),
                h: this.twelveHourClock(cd.getHours()),
                m: this.pad(cd.getMinutes(), 2),
                s: this.pad(cd.getSeconds(), 2),
            }

            this.time = `${t.h}:${t.m}:${t.s}`
            this.date = `${t.w} ${t.M} ${t.d}`
        },
